...
export interface ForManagerProposalRepository {
    ...
    getById(id: number, candidateId: string): Promise<ProposalControllerObject | null>; // Asume que devuelve algún tipo de objeto o entidad
    ...
    searchByEvent(id: string[]): Promise<Pick<ProposalControllerObject, 'id' | 'title'  | 'event'>[]>
}